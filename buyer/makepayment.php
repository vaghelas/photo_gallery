...
<input type="submit" name="submit" value="MAKE PAYMENT"  style="background:url(buy-btn.png) repeat-x 0 0; width:300px; height:30px;color:#FFF; margin:15px 0 0 0; text-align:center; line-height:30px; font-size:15px; border-radius:10px;" />
	</form>

    </div><br/>
            <?php
		$userid=$_SESSION['sellerid'];
		$sql10=mysql_query("select * from  sellerreg where sellerid='$userid'"); 
    ...
    <input type="submit"  value="Confirm Order" class="btn" style="margin:-48px 50px 0 600px; height:30px;"/>
    </form>
