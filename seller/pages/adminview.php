...
$sql=mysql_query("select * from adminreg");
echo "<table border='1'>";
echo "<tr>";
echo "<th>";
echo "AdminID";
...
echo "<td>";
echo "<a class='btn btn-info' href='adminregedit.php?id=$id'>Edit</a>";
echo "</td>";
echo "<td>";

echo "<a class='btn btn-danger' href='sellerdel.php?sellerid=$sellerid'>Delete</a>";
echo "</td>";
echo "</tr>";
}
echo "</table>";
