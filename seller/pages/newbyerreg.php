...
<div class="box-content">                        
 <form action="../buyer/buyerreg.php" enctype="multipart/form-data" method="post">
<table align="center" >
<tr>
<td> 
Name:
...
<div class="controls">
<label class="radio">
<input type="radio" name="txtstatus" id="optionsRadios1" value="0" checked="">
Yes
</label>
<label class="radio">
<input type="radio" name="txtstatus" id="optionsRadios2" value="1">
No
</label>
</div>
 </div>
