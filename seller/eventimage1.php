...
?>			
    ...
    echo "<a style='background:url(../seller/photomapping/$row[3])'  href='../seller/photomapping/$row[3]'><img src='../seller/photomapping/$row[3]' width='100' height='100' alt='' class='grayscale' /></a>";
	 echo "</li>";
