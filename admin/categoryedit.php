...
$cid=$_REQUEST['cid'];
$sql=mysql_query("select * from category where cid='$cid'");
...
{
$category1=$_POST['txtcategory'];
$sql=mysql_query("update category set category='$category1' where cid='$cid'");
...
<td>
<input type="text" name="txtcategory" value="<?php echo $category;?>" />
</td>
</tr>
