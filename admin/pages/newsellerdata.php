...
<body>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> New SellerData</h2>
						<div class="box-icon">
   ...
   <form action="../sellerdatainsert.php" enctype="multipart/form-data" method="post">
<table align="center" >
<tr>
<td> 
Title:
...
<td>
<input type="text" name="txtarea" height="20" width="50"/>
</tr>
</td>
<tr>
<td> 
...
<td>
<input type="text" name="txtcost" class="cleditor" />
</td>
</tr>
<tr>
<td> 
