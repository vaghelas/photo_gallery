...
$sql=mysql_query("select * from sellerdata where sdataid='$sdataid'");
...
$createddate=$_POST['txtcrate'];
$updateddate=$_POST['txtupdate'];
$size=$_POST['txtsize'];


//move_uploaded_file($_FILES['file']['tmp_name'],"sellerphoto/".$_FILES['file']['name']);
mysql_query("update sellerdata set title='$title',description='$description',cost='$cost',photo='$photo',createddate='$createddate',updateddate='$updateddate',size='$size' where sdataid='$sdataid'"); 
...
<td>
<input type="text" name="txtarea" height="20" width="50" value="<?php echo $description;?>"/>
</tr>
</td>
<tr>
<td> 
...
<td>
<input type="text" name="txtcost" class="cleditor" value="<?php echo $cost;?>"/>
</td>
</tr>
<tr>
<td> 
...
<td>
<input type="text" class="input-xlarge datepicker" id="date01" value="02/16/12" value="<?php echo $createddate;?>" >
</td>
</tr>
<tr>
<td> 
...
<td>
<input type="text" class="input-xlarge datepicker" id="date01" value="02/16/12" value="<?php echo $updateddate;?>">
</td>
</tr>
<tr>
<td> 
...
<input type="text" name="txtsize" value="<?php echo $size;?>"/>
</td>
</tr>
