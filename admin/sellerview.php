...
{															
echo "<a href='approve.php?sellerid=$sellerid' class='label label-important'>" .$row[15]."</a>";
}
elseif($row['status']=='Active')
{
echo "<a href='approve.php?sellerid=$sellerid' class='label label-success'>" .$row[15]."</a>";
