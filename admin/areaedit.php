...
$sql=mysql_query("select * from area where areaid='$areaid'");
...
$city1=$_POST['txtcity'];
$area1=$_POST['txtarea'];
$sql=mysql_query("update city set city='$city1',area='$area1' where areaid='$areaid'");
...
$sql=mysql_query("select cityid from area");
while($row=mysql_fetch_row($sql))
{
...
<td>
<input type="text" name="txtarea" value="<?php echo $area; ?>"/>
</td>
</tr>
