...
$hid=$_REQUEST['hid'];
$sql=mysql_query("select * from historicalplaces where hid='$hid'");
...
{
$name1=$_POST['txtname'];
$description1=$_POST['txtdesc'];
$sql=mysql_query("update historicalplaces set name='$name1',description='$description1' where hid='$hid'");
...
<td>
<input type="text" name="txtdesc" value="<?php echo $description;?>"/>
</tr>
</td>
<tr>
