...
$roll=$_POST['roll'];
	...
	mysql_query("update adminreg set name='$name',address='$address',gender='$gender',birthdate='$birthdate',city='$city',area='$area',contactno='$contactno',education='$education',email='$email',username='$username',password='$password',roll='$roll' where adminid='$adminid' ");
	echo "data updated";
...
<div class="controls">
<label class="radio">
<input type="radio" name="optionsRadios" id="optionsRadios1" value="Male" checked="" <?php echo($gender == "Male")? 'checked="checked"' : '' ?>>
Male
</label>
<label class="radio">
<input type="radio" name="optionsRadios" id="optionsRadios2" value="Female" <?php echo($gender == "Female")? 'checked="checked"' : ''?>>
Female
</label>
</div>
 </div>
...
<td>
<input type="text" name="txtbod" class="input-xlarge datepicker" id="date01" value="01/01/2014" value="<?php echo $birthdate; ?>"  />
</tr>
</td>
...
mysql_connect("localhost","root","");
mysql_select_db("gallery");
$query = mysql_query("select city from city where city='$city'");
...
mysql_connect("localhost","root","");
mysql_select_db("gallery");
$query = mysql_query("select area from area where area='$area'");
...
<td>
<input type="text" name="txteducation" value="<?php echo $education; ?>" />
</td>
</tr>
<tr>
<td> 
