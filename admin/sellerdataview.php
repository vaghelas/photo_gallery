<?php ob_start(); 
 ...
 ?>
 <div align="right">
			 <a class="btn btn-info" href="sellerview.php">
...
$sql=mysql_query("select * from sellerdata");
?>
...
echo "<td>";
$name=$row[1];
$sql1=mysql_query("select * from sellerreg where sellerid='$name'");
...
echo"<a class='btn btn-success' href='sellerdata.php'>
<i class='icon-zoom-in icon-white'></i>  
Add                                          
</a>";
echo"<a class='btn btn-info' href='sellerdataedit.php?sdataid=$sdataid'>
<i class='icon-edit icon-white'></i>  
Edit                                            
</a>";
echo "<a class='btn btn-danger' href='sellerdatadel.php?sdataid=$sdataid'>
