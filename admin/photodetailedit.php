...
mysql_query("update photodetail set sellerid='$sellerid', name='$name',photo='$photo',photocode='$photocode',description='$description',size='$size',category='$category' where photoid='$photoid'"); 
//echo "record update successfully....";
header("location:photodetailview.php");
}
