...
<?php      $sql1=mysql_query("select * from about limit 1");
    ...
    <?php /*?><div class="title"> Partners </div>
...
{
 $eid=$row3[0];
    echo  "<a href='buyer/buyereventimage.php?eid=$eid'><img src='seller/photomapping/$row3[5]' width='100' height='100' alt='' class='gallery' /></a>"; ?> 
...
{
 $eid=$row4[0];
echo "<a href='buyer/buyereventimage.php?eid=$eid'><img src='seller/photomapping/$row4[5]' width='100' height='100' alt='' class='gallery'/></a>";?>
  <?php }?>
</div>
</td></tr>
 <tr>
...
{
  $eid=$row5[0];
echo "<a href='buyer/buyereventimage.php?eid=$eid'><img src='seller/photomapping/$row5[5]' width='100' height='100' alt='' class='gallery'/></a>";?>
     <!--<a href="details.html"><img src="images/pic/2.jpg" width="100" height="100" alt="" class="gallery" /></a>
      <a href="details.html"><img src="images/pic/3.jpg" width="100" height="100" alt="" class="gallery" /></a>
      <a href="details.html"><img src="images/pic/4.jpg" width="100" height="100" alt="" class="gallery" /></a>
      <a href="details.html"><img src="images/pic/5.jpg" width="100" height="100" alt="" class="gallery" /></a>
